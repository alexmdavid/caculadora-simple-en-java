 ...
 * 
 * @author: $Author: ALEX D RUIDIAZ C $
 * @version: $Rev: 75 $
 * @date: $Date: 2009-04-14 00:21:18 +0200 (mar 14 de NOV de 2023) $ $Id:
 *        VentanaCalculadora.java 75 2023-11-13 22:21:18Z ALEX D RUIDIAZ C $
 */
public class VentanaCalculadora extends JFrame {
	...
	private void calcularResultado() {
            switch (operacion) {
                case "+" -> resultado += new Double(pantalla.getText());
                case "-" -> resultado -= new Double(pantalla.getText());
                case "/" -> resultado /= new Double(pantalla.getText());
                case "*" -> resultado *= new Double(pantalla.getText());
                default -> {
